...
public class SubjectFragment extends BaseFragment implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.logout:
                ...
                getFragmentManager().beginTransaction().replace(setContainerId(), CommonFragment.getInstance()).commit();
                break;
        }
        return true;
    }
    ...
    private void DialogPicker(){
        ...
        builder.setTitle("Configure Attendance");
        ...
        timelist.add("10:00Am - 12:00Am");
        timelist.add("1:00Pm - 2:00Pm");
        timelist.add("1:00Pm - 3:00Pm");
        timelist.add("1:00Pm - 4:00Pm");
